...
class IrBuiltIns(
    ...
    private fun defineCheckNotNullOperator(): IrSimpleFunctionSymbol {
        ...
        val typeParameter = IrTypeParameterImpl(
            UNDEFINED_OFFSET, UNDEFINED_OFFSET, BUILTIN_OPERATOR, typeParameterSymbol, Name.identifier("T"), 0, true, Variance.INVARIANT
        ).apply {
            superTypes += anyType
        }
        ...
        return symbolTable.declareSimpleFunctionIfNotExists(operatorDescriptor) {
            ...
            val valueParameter = IrValueParameterImpl(
                UNDEFINED_OFFSET, UNDEFINED_OFFSET, BUILTIN_OPERATOR, valueParameterSymbol, Name.identifier("arg"), 0,
