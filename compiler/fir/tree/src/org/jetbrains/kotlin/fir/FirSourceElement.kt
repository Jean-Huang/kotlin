...
sealed class FirFakeSourceElementKind : FirSourceElementKind() {
    ...
    object DelegatedTypeRef : FirFakeSourceElementKind()
    ...
    // if (true) 1 --> if(true) { 1 }
    // with a fake sources for the block which refers to the wrapped expresion
    ...
    object GeneratedComparationExpression : FirFakeSourceElementKind()
